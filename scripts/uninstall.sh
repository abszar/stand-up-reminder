...
rm -f "$user_data_root/icons/hicolor/scalable/apps/stand-up-reminder-paused-symbolic.svg"
rm -f "$user_data_root/icons/hicolor/scalable/status/stand-up-reminder-paused-symbolic.svg"
rm -rf "$user_data_root/fonts/stand-up-reminder"
